...
class PriceProcessor:
    ...
    def _process_stock_price(self, stock_price: pd.DataFrame, temp_cumprod: dict[str, float], is_latest_file: bool) -> pd.DataFrame:
        ...
        stock_price['Code'] = self._replace_code(stock_price['Code'])
    ...
    def _apply_cumulative_adjustment_factor(
        ...
        stock_price = stock_price.groupby('Code', group_keys=False).apply(self._calculate_cumulative_adjustment_factor).reset_index(drop=False)
