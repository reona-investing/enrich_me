...
from acquisition.features_updater import SingleFeatureScraper, ScrapedDataMerger
import pandas as pd
import asyncio
...
if __name__ == '__main__':
    asyncio.get_event_loop().run_until_complete(FeaturesUpdateFacade().update_all())