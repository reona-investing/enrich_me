...
class TradingFacade:
    ...
    async def take_positions(self, 
        ...
        orders_df, _ = await stock_selector.select(self.margin_manager.buying_power)
        order_maker = NewOrderMaker(orders_df, self.new_order_manager, self.margin_manager)
    ...
    async def take_additionals(self):
        ...
        '''
        order_maker = AdditionalOrderMaker(self.new_order_manager, self.margin_manager)
