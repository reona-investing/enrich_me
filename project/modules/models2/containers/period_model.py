...
class PeriodSwitchingModel:
    ...
    def add_model_period(self, 
                         model: Union[BaseModel, ModelContainer], 
                         start_date: datetime,
    ...
    def get_active_model_for_date(self, date: datetime) -> Tuple[str, Union[BaseModel, ModelContainer]]:
        """
        ...
        Returns:
            Tuple[str, Union[BaseModel, ModelContainer]]: 
                モデル名とモデルのタプル
