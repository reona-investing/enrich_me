...
lasso_collection = CollectionFactory().load_collection(collection_path)

for sector, single_model in lasso_collection.get_models():
    ...
    single_model.update_dataset(target_for_sector, features_for_sector)
