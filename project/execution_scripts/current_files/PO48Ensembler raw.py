...
from facades.data_pipeline.considerations.raw_target import MachineLearningFacade
...
async def main() -> None:
    ...
    datasets_path1 = f"{Paths.ML_DATASETS_FOLDER}/48sectors_LASSO_raw_learned_in_250619"
    datasets_path2 = f"{Paths.ML_DATASETS_FOLDER}/48sectors_LightGBM_raw_learned_in_250619"
    ensembled_datasets_path = f"{Paths.ML_DATASETS_FOLDER}/48sectors_Ensembled_raw_learned_in_250615"
    model1_weight = 6.7
    model2_weight = 1.3
