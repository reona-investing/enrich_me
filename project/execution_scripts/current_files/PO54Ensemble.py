...
async def main() -> None:
    ...
    # パラメータ設定
    sector_redef_csv = f"{Paths.SECTOR_REDEFINITIONS_FOLDER}/54sectors_2024-2025.csv"
    sector_index_parquet = f"{Paths.SECTOR_PRICE_FOLDER}/54sectors_price.parquet"
    datasets_path1 = f"{Paths.ML_DATASETS_FOLDER}/54sectors_LASSO_learned_in_250623"
    datasets_path2 = f"{Paths.ML_DATASETS_FOLDER}/54sectors_LightGBMlearned_in_250623"
    ensembled_datasets_path = f"{Paths.ML_DATASETS_FOLDER}/54sectors_Ensembled_learned_in_250623"
    model1_weight = 6.7
    model2_weight = 1.3
